...
Almost no extra work needs to be done for differing message or tweak lengths, unless
new powers of the hash key are needed for parallelism. HPolyC does not need NH subkeys and
so is much more key agile, but its hashing stage is slower on large inputs.
