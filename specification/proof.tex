...
\begin{align*}
    ...
    &\left| \prob{A^{S_{K}}\Rightarrow 1 | K \sample \mathcal{K}_S}\right.
    \\
...
\begin{proof}
    ...
    \begin{align*}
        \rho_X \defeq& \condprob{A^{\eta_{K_H, \pi, F}, \eta_{K_H, \pi, F}^{-1}}\Rightarrow 1}{K_H, \pi, F \sample \Omega_X} \\
        \rho_Y \defeq& \condprob{A^{\mathcal{E}, \mathcal{D}}\Rightarrow 1}{\mathcal{E}, \mathcal{D} \sample \Omega_Y} \\
    \end{align*}
...
\begin{proof}[Proof of \autoref{hbshadvantage}]\label{hbshproof}
    ...
    where
    \begin{align*}
        \rho_V \defeq& \condprob{A^{\HBSH_{K_S}, \HBSH_{K_S}^{-1}}\Rightarrow 1}{K_S \sample \mathcal{K}_S} \\
        \rho_Z \defeq& \condprob{A^{\bm{\pi},\bm{\pi}^{-1}}\Rightarrow 1}{\bm{\pi} \sample \Perm^\mathcal{T}(\mathcal{M})} \\
    \end{align*}
    ...
    \begin{align*}
        \rho_W \defeq& \condprob{A^{\bar{\eta}_{F}, \bar{\eta}_{F}^{-1}}\Rightarrow 1}{F \sample (\mathcal{N} \rightarrow \bin^{l_S})} \\
    \end{align*}
