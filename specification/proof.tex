...
We here prove a relationship between the security properties of the
primitives used to build HBSH, and those of HBSH itself.
...
$L \in \mathcal{L}$, $R \in \bin^n$, $L \Concat R \in \mathcal{M}$.
