...
%%% script TITLE: {HBSH}, {Adiantum} and {HPolyC}: length-preserving encryption for entry-level processors%%%
...
\title{{HBSH}, {Adiantum}, and {HPolyC}: length-preserving encryption for entry-level processors}
\iftoggle{iacr}{
...
$( 2^{-126} + 2^{-103}(1 + \ceil{l_T/128} + 2\ceil{(l_P - 128)/2048}))\binom{q}{2}
+ \advantage{\pm \mathrm{prp}}{E_{K_E}}[(q, t')]
