...
\parintro{Message space}
For a given key and nonce, XChaCha12 produces $l_S = 2^{73}$ bits of output.
The left-hand side of the plaintext or ciphertext is thus drawn from the space
$\mathcal{L} = \bigcup_{i=0}^{l_S}\bin^i$
and the space of Adiantum/HPolyC plaintexts and ciphertexts
