...
\begin{itemize}
    ...
    \item $H: \mathcal{K}_H \times \mathcal{T} \times \mathcal{L} \rightarrow \bin^n$: two-argument hash function with keyspace $\mathcal{K}_H$
    \item $\boxplus, \boxminus: \bin^n \times \bin^n \rightarrow \bin^n$: group operations
    \item $E: \mathcal{K}_E \times \bin^n \rightarrow \bin^n$: $n$-bit block cipher with key space $\mathcal{K}_E$
...
pair of elements in $\mathcal{L} \times \bin^n$ such that
$P_L \Concat P_R = P$.
